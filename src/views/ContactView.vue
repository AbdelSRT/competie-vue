    ...
    <section class="mb-32">
      <div class="flex justify-center">
        <div class="text-center md:max-w-xl lg:max-w-3xl">
          <h2 class="px-6 mb-12 text-3xl font-bold">Contact us</h2>
        </div>
      </div>
      ...
      <div class="flex flex-wrap">
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
          <div class="flex flex-wrap">
            <div class="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
              <div class="flex items-start">
                <div class="shrink-0">
                  <div class="inline-block p-4 text-teal-700 rounded-md bg-teal-400-100">
                    <svg
                ...
                <div class="ml-6 grow">
                  ...
                  <p class="text-neutral-500">essarti_abdelouahid@hotmail.com</p>
                  <p class="text-neutral-500">0485/92 91 83</p>
                </div>
              </div>
            </div>
            <div class="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
